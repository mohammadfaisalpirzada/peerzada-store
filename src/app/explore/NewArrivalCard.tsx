...
export default function NewArrivalCard({ product }: NewArrivalCardProps) {
    ...
    >
      <div className="relative h-64 w-full">
        ...
        <motion.div
          ...
          className="absolute top-2 right-2 z-10 bg-red-500 text-white text-xs font-bold px-2 py-1 rounded-full shadow-lg"
        >
          NEW
        </motion.div>
      ...
      <div className="flex flex-col flex-1 p-4">
        ...
        <div className="mt-auto space-y-2">
          ...
          <button
            ...
            className="w-full bg-green-600 hover:bg-green-700 text-white font-medium py-2 px-4 rounded transition-colors duration-300 flex items-center justify-center gap-2"
            disabled={product.inStock === false}
          >
